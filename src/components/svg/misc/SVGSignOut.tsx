...
export default function SVGSignOut(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={21} height={21} fill="none" viewBox="0 0 24 24" {...props}>
      <path
        fillRule="evenodd"
