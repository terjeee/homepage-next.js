...
export default function SlideShow() {
  return (
    <div className="relative py-10 flex overflow-hidden before:absolute before:z-10 before:bg-gradient-to-r before:from-white before:to-0% before:top-0 before:left-0 before:w-36 before:h-full after:absolute after:z-10 after:bg-gradient-to-l after:from-white after:to-0% after:top-0 after:right-0 after:w-36 after:h-full">
